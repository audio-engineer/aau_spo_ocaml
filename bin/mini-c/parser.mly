/* Parser for the mini-c compiler */
...
%{
  ...
  (* Constructing expressions and statements with localization *)
...
%token INT STRUCT SIZEOF MALLOC
...
| SIZEOF LPAR STRUCT id = ident RPAR
    { Esizeof id }
| MALLOC LPAR SIZEOF LPAR STRUCT id = ident RPAR RPAR
    { Emalloc id }
;
